...
class processor:
    ...
    def historical_download(start_time, end_time, interval, include_sentiment_analysis=False, load_pickle=True):
        ...
        if load_pickle:
            ...
            with open('kraken_USD_data.pickle', 'wb') as f:
            ...
            with open('gdax_USD_data.pickle', 'wb') as f:
        ...
        # TODO: Check that the minutes between the LAST 2 datapoints == interval
