...
class GDAX(Preprocessor):
    ...
    def get_training_data(self):
        ...
        trades, last = self.request_trade_slice(slice_start)
        while last < end_timestamp:
            slice_start = datetime.fromtimestamp(last)
            new_data, last = self.request_trade_slice(self, slice_start)
    ...
    def request_trade_slice(self, start):
        """
        ...
        trades, last = self.k.get_recent_trades(self.currency_pair, since=timestamp, ascending=True)
